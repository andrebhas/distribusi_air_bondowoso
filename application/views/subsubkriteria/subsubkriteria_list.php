...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title">Subsubkriteria List</h5>
        ...
        <div class="panel-body"> 
            ...
            ?>
                    <tr>
						...
						<td><?php echo $ci->Subkriteria_model->get_by_id($subsubkriteria->id_subkriteria)->nama_subkriteria ?></td>
						<td><?php echo $subsubkriteria->deskripsi ?></td>
						<td><?php echo $subsubkriteria->nilai ?></td>
						<td style="text-align:center" width="200px">
						<?php 
                            if ($subkriteria) {
                                echo anchor(site_url('subsubkriteria/read/'.$subsubkriteria->id_subsubkriteria),'Detail'); 
                                echo ' | '; 
                                echo anchor(site_url('subsubkriteria/update/'.$subsubkriteria->id_subsubkriteria),'Update'); 
                                echo ' | '; 
                                echo anchor(site_url('subsubkriteria/delete/'.$subsubkriteria->id_subsubkriteria),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');  
                            } else {
                                echo anchor(site_url('subsubkriteria/read/'.$subsubkriteria->id_subsubkriteria),'Detail');
                            }
