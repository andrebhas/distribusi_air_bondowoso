        ...
        <div class="panel-body"> 
            <div class="row">
                <div class="col-md-5 text-left">
					...
					<?php //echo anchor(site_url('users/excel'), '<i class="fa fa-file-excel-o"></i>', 'class="btn btn-success btn-xs" data-popup="tooltip-custom" title="export ms.excel"'); ?>
					<?php //echo anchor(site_url('users/word'), '<i class="fa fa-file-word-o"></i>', 'class="btn btn-primary btn-xs"  data-popup="tooltip-custom" title="export ms.word"'); ?>
				</div>
